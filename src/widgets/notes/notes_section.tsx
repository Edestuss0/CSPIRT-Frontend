...
import {useAddNote} from "../../features/notes/hooks/use_add_note.ts";
import type {UserType} from "../../entities/user/types/user_types.ts";
import {useDeleteNote} from "../../features/notes/hooks/use_delete_note.ts";
import {useUser} from "../../features/users/hooks/use_user.ts";
import {NoteAddUsecase} from "../../features/notes/models/note_add_usecase.ts";
