...
import type { ScheduleAddFormValues } from "../../model/add_schedule_usecase";
import {dayLabels, type ScheduleDay} from "../../../../../shared/entities/schedule/types/schedule_types";
import {useChangeScheduleStore} from "../../store/add_schedule_store.ts";
...
export function AddScheduleLessonModal({isOpen, onClose, classId, dayOfWeek, onAdded, type}: AddScheduleLessonModalProps) {
    ...
    const addSchedule = useChangeScheduleStore((state) => state.addSchedule);
